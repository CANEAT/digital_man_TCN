...
from Digital_man.Output_transform.comm_api import *
import os
import pickle
import numpy as np
import datetime
...
# BlendShapes.
BlendShapesNames = ["mouthLowerDown_L", "cheekSquint_L", "mouthDimple_R", "mouthPress_L", "mouthStretch_R",
                    "mouthFunnel", "mouthLowerDown_R", "mouthLeft", "cheekSquint_R", "jawOpen", "jawForward",
                    "mouthPress_R", "jawRight", "mouthShrugLower", "mouthFrown_L", "cheekPuff", "mouthStretch_L",
                    "mouthRollLower", "mouthUpperUp_R", "mouthShrugUpper", "mouthSmile_L", "mouthClose", "jawLeft",
                    "mouthDimple_L", "mouthFrown_R", "mouthPucker", "mouthRight", "mouthSmile_R", "mouthUpperUp_L",
                    "mouthRollUpper"]
...
def transObs2fbxFile(fname):
    ...
    fbxFile = '../output/fmy2bsx/' + midName + '.bsx'
    jsonFile = '../output/fmy2bsx/' + midName + '.json'
...
def BatchWork_fmy2Bsx():
    begin_new_listfile()
    allOutFile = list_all_fm_file('E:\项目\\deecamp\\code\\Digital_man_TCN_pytorch1\\Digital_man\\output\\fmy_result\\',
                                  'fm_y')
    # print(len(allOutFile))
